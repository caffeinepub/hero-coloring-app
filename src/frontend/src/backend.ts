...
import type { Artwork as _Artwork, ArtworkId as _ArtworkId, ExternalBlob as _ExternalBlob, HeroId as _HeroId, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createArtwork(arg0: string, arg1: ExternalBlob, arg2: ExternalBlob, arg3: HeroId): Promise<ArtworkId> {
        if (this.processError) {
            try {
                const result = await this.actor.createArtwork(arg0, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg1), await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg2), arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteArtwork(arg0: ArtworkId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getArtwork(arg0: ArtworkId): Promise<Artwork> {
        if (this.processError) {
            try {
                const result = await this.actor.getArtwork(arg0);
                return from_candid_Artwork_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getHero(arg0: HeroId): Promise<HeroId> {
        if (this.processError) {
            try {
                const result = await this.actor.getHero(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOwnedArtworkIds(): Promise<Array<ArtworkId>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOwnedArtworkIds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Artwork_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Artwork): Promise<Artwork> {
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    id: _ArtworkId;
    coloredImage: _ExternalBlob;
    originalImage: _ExternalBlob;
    hero: _HeroId;
    name: string;
    artist: Principal;
}): Promise<{
    ...
    return {
        id: value.id,
        coloredImage: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.coloredImage),
        originalImage: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.originalImage),
        hero: value.hero,
        name: value.name,
        artist: value.artist
    };
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Artwork>): Promise<Array<Artwork>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Artwork_n12(_uploadFile, _downloadFile, x)));
}
